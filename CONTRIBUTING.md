...
1. To begin, [fork this project], clone your fork, and add our upstream.
   ...
   git clone https://github.com/<your-username>/retry-until-online
   # Navigate to the newly cloned directory
   cd retry-until-online
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/maoberlehner/retry-until-online
...
[already been reported]: https://github.com/maoberlehner/retry-until-online/issues
[fork this project]:     https://github.com/maoberlehner/retry-until-online/fork
